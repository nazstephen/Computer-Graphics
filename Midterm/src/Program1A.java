...
public class Program1A {
	public static void main(String args[]) throws IOException {
		BufferedImage inputImage = ImageIO.read(new File("superman.jpg"));
		brighten(inputImage);
	}
	
	public static void brighten(BufferedImage inputImage) {
		...
		try {
			ImageIO.write(outputImage, "jpg", new File("bright.jpg"));
		} catch (IOException e) {
